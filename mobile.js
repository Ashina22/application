...
async function initMap() {
  ...
  directionsRenderer.setOptions({
    polylineOptions: {
      strokeColor: "Blue", //can change the color to green to match thheme
      strokeOpacity: 1,
      strokeWeight: 7,
    },
  });

  // Add custom "Layers" button
  const layersControlDiv = document.createElement("div");
  layersControlDiv.style.backgroundColor = "#fff";
  layersControlDiv.style.border = "2px solid #ccc";
  layersControlDiv.style.borderRadius = "5px";
  layersControlDiv.style.padding = "5px";
  layersControlDiv.style.cursor = "pointer";
  layersControlDiv.style.margin = "10px";
  layersControlDiv.style.boxShadow = "0 2px 6px rgba(0,0,0,0.3)";
  layersControlDiv.style.position = "absolute"; // Use absolute positioning
  layersControlDiv.style.top = "90px"; // Adjust top position
  layersControlDiv.style.right = "10px"; // Adjust left positio
  layersControlDiv.innerHTML = `
  <img src="img/layer.png" alt="Map View" style="width: 20px; height: 20px;" /> Layers
`;
  layersControlDiv.style.fontSize = "10px";

  // Add click event to toggle between Satellite and Map views
  let isSatellite = false;
  layersControlDiv.addEventListener("click", () => {
    ...
    layersControlDiv.innerHTML = isSatellite ? "Satellite" : "Map";

    // Revert back to "Layers" after 3 seconds
    setTimeout(() => {
      layersControlDiv.innerHTML = `<img src="img/layer.png" alt="Map View" style="width: 20px; height: 20px;" /> Layers
`;
    }, 1000);
  });

  // Position the custom control on the map
  // Manually append the custom control to the map container
  document.getElementById("map").appendChild(layersControlDiv);
  ...
  const features = [
    {
      ...
      description: "College of Arts & Science",
    },
    {
      position: { lat: 8.953213412910166, lng: 125.5982116566809 },
      info: "Department of Science and Technology Caraga Region",
      image: "img/dost.jpg",
      link: "dost.html",
      icon: "img/dpt.png", // Specific icon for this location
      description:
        "(DOST-Caraga) promotes scientific and technological advancements to drive innovation and development in the Caraga region",
    },
    {
    ...
    },
    {
      ...
      icon: "img/college.png", // Specific icon for this location
      description:
        "The Caraga State University (CSU) HERO Learning Commons the largest library in the Caraga region",
    },
    {
      ...
      link: "nsb.html",
      icon: "img/college.png", // Specific icon for this location
      description: "College of Mathematics and Natural Sciences",
    },
    {
      position: { lat: 8.959, lng: 125.5957 },
      info: "College of Agriculture and Agri-Industries (CAA)",
      image: "img/caa.jpg",
      link: "caa.html",
      icon: "img/college.png", // Specific icon for this location
      description:
        "Provides education, research, and training in agriculture and agri-industrial technologies to support sustainable development",
    },
    {
      ...
      link: "cofes.html",
      description:
        "Focuses on education, research, and sustainable practices in forestry and environmental sciences",
    },
    {
      ...
      link: "chass.html",
      description:
        "CHASS offers programs in the arts, humanities, and social sciences, fostering critical thinking and cultural awareness",
    },
    {
      ...
      icon: "img/college.png", // Specific icon for this location
      link: "masawa.html",
      description: "Click image to view building contents",
    },
    {
      ...
      icon: "img/college.png", // Specific icon for this location
      description:
        "(CCIS) specializes in computing, information technology, and data sciences, preparing students for the digital industry",
    },
    {
      ...
      icon: "img/college.png", // Specific icon for this location
      description:
        "Offers programs in engineering and geosciences, focusing on technological innovation and sustainable development",
    },
    {
      ...
      icon: "img/college.png", // Specific icon for this location
      description:
        "CED prepares future educators through quality teaching, research, and community engagement in the field of education",
    },
    {
    ...
    },
    {
      ...
      description:"Located beside CAA building"
    },
    {
      ...
      icon: "img/dpt.png", // Specific icon for this location
      description:
        "OATC provides training, research, and advocacy for sustainable and organic farming practices",
    },
    {
      ...
      link: "hostel.html",
      icon: "img/college.png", // Specific icon for this location
      description: "This facility contains the university clinic",
    },
    {
      ...
      description:
        "Oversees athletic programs, facilities, and events, promoting physical fitness and sports development within the university",
    },
    {
  ...
  for (const feature of features) {
    ...
    const infoWindowContent = `
      ...
      feature.info
    }" style="max-width: 200px; height: 100px; margin-bottom: 10px; border-radius: 10px">
        </a>
        <h6>${feature.info}</h6>
...
window.addEventListener("touchstart", function (e) {
  ...
  if (iframe) {
    iframe.contentWindow.postMessage(
      {
        type: "touchstart",
        touches: e.touches, // Array of touch points
      },
      "*"
    );
  }
...
function searchLocation() {
  ...
  const found = markers.filter((m) =>
    m.info.toLowerCase().includes(searchInput)
  );
  ...
  if (found.length > 0) {
    if (found.length === 1) {
      ...
      alert(
        `Multiple locations found: ${found.map((loc) => loc.info).join(", ")}`
      );
    }
  } else {
    const searchLocations = {
      registrar: {
        lat: 8.956943189494943,
        lng: 125.59745241416188,
        info: "Registrar",
        image: "img/registrar.jpg",
        link: "nsb-canteen.html",
        description:
          "This is the Registrar's office, where students can manage their academic records.",
      },
      oas: {
        lat: 8.95689685581763,
        lng: 125.59717054069868,
        info: "OAS",
        image: "img/oas.jpg",
        link: "nsb-canteen.html",
        description: "Office of admission and scholarship",
      },
      "food technology center": {
        lat: 8.95885218261509,
        lng: 125.59633765001367,
        info: "Food Technology Center",
        image: "img/canteen.jpg",
        link: "nsb-canteen.html",
        description: "",
      },
      "caraga food innovation center": {
        lat: 8.958682057187627,
        lng: 125.59588324874615,
        info: "Caraga Food Innovation Center",
        image: "img/canteen.jpg",
        link: "nsb-canteen.html",
        description: "",
      },
      "organic agriculture training center": {
        lat: 8.953670505991782,
        lng: 125.5971810025196,
        info: "Organic Agriculture Training Center",
        image: "img/oatc.jpg",
        link: "nsb-canteen.html",
        description: "",
      ...
      "nsb canteen": {
        lat: 8.958486428920668,
        lng: 125.5972223715645,
        info: "NSB Canteen",
        image: "img/canteen.jpg",
        link: "nsb-canteen.html",
        description: "",
      },
      "new science building (nsb/batok hall)": {
        lat: 8.957890221298307,
        lng: 125.5969669581597,
        info: "New Science building (NSB/Batok Hall)",
        image: "img/nsb.jpg",
        link: "nsb.html",
        description: "",
      },
      "csu main college of forestry and environmental sciences (cofes)": {
        lat: 8.9532,
        lng: 125.5972,
        info: "CSU Main College of Forestry and Environmental Sciences (COFES)",
        image: "img/cofes.jpg",
      ...
      "farm mechanization center": {
        lat: 8.957465490271211,
        lng: 125.59814632842759,
        info: "Farm Mechanization Center",
        image: "img/farmmech.jpg",
        link: "farmmech.html",
        description: "",
      },
      "college of humanities and social sciences/kinaadman hall": {
        lat: 8.956091004584328,
        lng: 125.59792323787687,
        info: "College of Humanities and Social Sciences/Kinaadman Hall",
        image: "img/kinaadman.jpg",
        link: "chass.html",
        description: "",
      ...
      "new administration building": {
        lat: 8.957250380365862,
        lng: 125.59764832350852,
        info: "New Administration Building",
        image: "img/admin.jpg",
        link: "admin.html",
        description: "",
      },
      "old administration building": {
        lat: 8.956825777829309,
        lng: 125.59738154793322,
        info: "Old Administration Building",
        image: "img/oldadmin.jpg",
        link: "oldadmin.html",
        description: "",
      },
      "anex 2 building": {
        lat: 8.954527524733473,
        lng: 125.59807198444454,
        info: "Anex 2 Building",
        image: "img/anex.jpg",
        link: "http://example.com/anex",
        description: "",
      },
      "anex 3 building": {
        lat: 8.956476963908328,
        lng: 125.59541117924815,
        info: "Anex 3 Building",
        image: "img/anex.jpg",
        link: "anex1.html",
      },
      villares: {
        lat: 8.953157960469824,
        lng: 125.59738112140803,
        info: "CSU Villares Building",
        image: "img/cofes.jpg",
        link: "",
        description: "",
      },
      "csu main hero learning commons": {
        lat: 8.95786387399443,
        lng: 125.59635007361663,
        info: "CSU Main HERO Learning Commons",
        image: "img/library.jpg",
        link: "lib.html",
      },
      "old cas building": {
        lat: 8.955575598052341,
        lng: 125.59664046282884,
        info: "Old CAS Building",
        image: "img/oldcas.jpg",
        link: "oldcas.html",
        description: "College of Arts & Science",
      },
      ...
      field: {
        lat: 8.956543619178424,
        lng: 125.59649493048896,
        info: "Field",
        image: "img/oval.jpg",
        link: "field.html",
      },
      "boffo food hub canteen": {
      ...
      osas: {
        lat: 8.956938598181836,
        lng: 125.5974861856326,
        info: "Osas",
        image: "img/osas.jpg",
        link: "http://example.com/osas",
      },
      "eco hall": {
        lat: 8.955018346783993,
        lng: 125.5969820861699,
        info: "Eco Hall",
        image: "img/ecohall.jpg",
        link: "http://example.com/osas",
      },
      "sports office": {
        lat: 8.955562274721453,
        lng: 125.59594834589646,
        info: "Sports Office",
        image: "img/sports.jpg",
        link: "sports.html",
      },
      "csu main gymnasium and cultural center": {
        lat: 8.955977741789837,
        lng: 125.59566640516326,
        info: "CSU Main Gymnasium and Cultural Center",
        image: "img/img/gym.jpg",
        link: "gym.html",
      },
      "college of education (ced)": {
        lat: 8.959289352385552,
        lng: 125.59702311903386,
        info: "College of Education (Ced)",
        image: "img/ced.jpg",
        link: "ced.html",
      },
      "ced canteen": {
        lat: 8.959464451759239,
        lng: 125.59725271438047,
        info: "CED Canteen",
        image: "img/cedcanteen.jpg",
        link: "ced-canteen.html",
      },
      "caa canteen": {
        lat: 8.959087604461281,
        lng: 125.59593194296626,
        info: "CAA Canteen",
        image: "img/caacanteen.jpg",
        link: "caa-canteen.html",
        description: ""
      ...
      "cofes canteen": {
        lat: 8.953314087321177,
        lng: 125.59714493015973,
        info: "COFES Canteen",
        image: "img/osas.jpg",
        link: "cofes-canteen.html",
        description: ""
      },
      "department of science and technology caraga region(dost)": {
        lat: 8.953213412910166,
        lng: 125.5982116566809,
      ...
      "college of engineering and geosciences(cegs)": {
        lat: 8.954970254233311,
        lng: 125.59793373424142,
        info: "College Engineering and Geosciences(CEGS)",
        image: "img/cegs.jpg",
        link: "cegs.html",
        description: ""
      ...
      "masawa hall": {
        lat: 8.955532271257468,
        lng: 125.59851599862621,
        info: "Masawa Hall",
        image: "img/masawa.jpg",
        link: "masawa.html",
        description: ""
      ...
      "caa greenhouse": {
        lat: 8.958930947394402,
        lng: 125.59506156797713,
        info: "CAA Greenhouse",
        image: "img/greenhouse.jpg",
        link: "caa-greenhouse.html",
        description: "Located beside CAA building"
      ...
      "hostel building": {
        lat: 8.958735140337026,
        lng: 125.59833326532635,
        info: "Hostel Building",
        image: "img/hostel.jpg",
        link: "hostel.html",
        description: "This facility contains the university clinic"
      },
      "csu personnel multipurpose cooperative canteen": {
        lat: 8.955626166710692,
        lng: 125.59704251248058,
        info: "CSU Personnel multipurpose cooperative canteen",
        image: "",
        link: "coo-canteen.html",
        description: "Open Modnday to Friday located"
      },
      clinic: {
        lat: 8.95865014355704,
        lng: 125.59801501452652,
        info: "Clinic",
    ...
    if (matchedLocations.length > 0) {
      if (matchedLocations.length === 1) {
        ...
        alert(
          `Multiple locations found: ${matchedLocations
            .map((loc) => searchLocations[loc].info)
            .join(", ")}`
        );
      }
    } else {
...
document.getElementById("use-my-location").addEventListener("change", function () {
  ...
  if (this.checked) {
    ...
    startInput.setAttribute("disabled", "disabled"); // Disable input
    startInput.classList.add("location-active"); // Add a class for styling
  } else {
    startInput.value = "";
    startInput.removeAttribute("disabled"); // Enable input
    startInput.classList.remove("location-active"); // Remove the class
  }
});
...
async function getDirections() {
  ...
  try {
    ...
    if (!useMyLocation && searchLocations[startInput]) {
      const locationData = searchLocations[startInput];
...
document
  .getElementById("clear-directions-button")
